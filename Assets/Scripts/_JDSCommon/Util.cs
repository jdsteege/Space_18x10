...
public static class Util
{
	...
	// CanvasGroup handles this better.
	//    public static void EnableBehaviours<T>(this GameObject parent, bool enabled) where T : Behaviour
	//    {
	...
	//    }
	//
	//    public static void EnableRenderers<T>(this GameObject parent, bool enabled) where T : Renderer
	//    {
	//        T[] children = parent.GetComponentsInChildren<T>();
	//        for(int i = 0; i < children.Length; i++)
	//        {
	...
	//    }
	//
	//    public static void EnableUI(this GameObject parent, bool enabled)
	//    {
	//        parent.EnableBehaviours<UnityEngine.UI.Graphic>(enabled);
	//    }
